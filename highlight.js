...
illegal:"[^\\s\\}\\{]"}}})());hljs.registerLanguage("d",(()=>{"use strict";return e=>{const a={
...
begin:"@[a-zA-Z_][a-zA-Z_\\d]*"}]}}})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
...
begin:"\\\\\\n"}]}}},{className:"attr",begin:n+t+"$"}]}}})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
starts:{end:/^(?![ ]{6})/,subLanguage:"julia"},aliases:["jldoctest"]}]})})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
className:{1:"keyword",3:"title.class"}}])}}})());hljs.registerLanguage("pgsql",(()=>{"use strict";return E=>{
...
aliases:["yml"],contains:b}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("diff",(()=>{"use strict";function e(...e){
return"("+((e=>{const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
